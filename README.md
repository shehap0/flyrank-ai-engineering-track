...
**AI-Tooling:** OpenCode, google ai studio, gemini cli, vscode copilot

## Tracks

| Track | Folder | Description |
|---|---|---|
| Frontend AI Engineering | `Frontend AI engineering/` | Building features with AI-assisted workflows, verified and reviewed |
| AI Fluency | `AI Fluency/` | Directing AI tools deliberately — prompting, verification, review |
